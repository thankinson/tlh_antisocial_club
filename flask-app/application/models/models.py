...
class Phonenumber(db.Model):
    ...
    phone_number = db.Column(db.Integer, nullable=False, default='')
...
class Address(db.Model):
    ...
    address_line_one = db.Column(db.String(30), nullable=False, default='')
    address_line_two = db.Column(db.String(30), nullable=False, default='')
    address_location = db.Column(db.String(30), nullable=False, default='')
    address_postcode = db.Column(db.String(30), nullable=False, default='')
